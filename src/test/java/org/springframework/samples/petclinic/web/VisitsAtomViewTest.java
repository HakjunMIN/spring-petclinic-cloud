...
// added to the classpath inside the Maven pom.xml file (inside <build***REMOVED*** <testResources***REMOVED*** ***REMOVED*** </testResources***REMOVED*** </build***REMOVED***)
@ContextConfiguration({"classpath*:mvc-*-config.xml", "classpath*:spring/*-config.xml"***REMOVED***)
@ActiveProfiles("jdbc")
public class VisitsAtomViewTest {
	...
	***REMOVED***
	...
	private Map<String, Object***REMOVED*** model;
	...
	***REMOVED***
	...
	public void setUp() {
		...
		List<Visit***REMOVED*** visits = new ArrayList<Visit***REMOVED***();
		visits.add(belloVisit);
		visits.add(wodanVisit);

		model = new HashMap<String, Object***REMOVED***();
	...
	***REMOVED***
	...
	public void buildFeedEntries() throws Exception {
		List<Entry***REMOVED*** entries = visitView.buildFeedEntries(model, null, null);
