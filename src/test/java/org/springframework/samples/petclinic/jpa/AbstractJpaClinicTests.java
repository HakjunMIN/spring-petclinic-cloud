 ...
 * <li***REMOVED***Provides useful inherited protected fields, such as a
 * {@link SimpleJdbcTemplate***REMOVED*** that can be used to verify database state after
 ...
 * {@link #countRowsInTable(String)***REMOVED***, {@link #deleteFromTables(String[])***REMOVED***,
 * etc. An ApplicationContext is also inherited, and can be used for explicit
 * lookup if necessary.</li***REMOVED***
 * </ul***REMOVED***
 * <p***REMOVED***
...
public abstract class AbstractJpaClinicTests extends AbstractJpaTests {
	 ...
	 * <code***REMOVED***org.springframework.test</code***REMOVED*** package.
	 *
