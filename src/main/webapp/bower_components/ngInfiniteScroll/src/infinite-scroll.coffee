...
mod.directive 'infiniteScroll', ['$rootScope', '$window', '$interval', 'THROTTLE_MILLISECONDS', \
                                  ($rootScope, $window, $interval, THROTTLE_MILLISECONDS) -***REMOVED***
  scope:
    infiniteScroll: '&'
  ...
  link: (scope, elem, attrs) -***REMOVED***
    ...
    handleInfiniteScrollDistance = (v) -***REMOVED***
    ...
    handleInfiniteScrollDisabled = (v) -***REMOVED***
      scrollEnabled = !v
    ...
    handleInfiniteScrollUseDocumentBottom = (v) -***REMOVED***
      useDocumentBottom = v
    ...
    changeContainer = (newContainer) -***REMOVED***
      if container?
        container.unbind 'scroll', handler
    ...
    handleInfiniteScrollContainer = (newContainer) -***REMOVED***
