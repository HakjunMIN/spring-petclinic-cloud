...
layout = hogan.compile(layout, { sectionTags: [{o:'_i', c:'i'***REMOVED***] ***REMOVED***)
...
pages.forEach(function (name) {
  ...
  context.title = name
    .replace(/\.mustache/, '')
    .replace(/\-.*/, '')
    .replace(/(.)/, function ($1) { return $1.toUpperCase() ***REMOVED***)
  ...
  ***REMOVED***
  ...
  page = hogan.compile(page, { sectionTags: [{o:'_i', c:'i'***REMOVED***] ***REMOVED***)
