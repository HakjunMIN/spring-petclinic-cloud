...
jQuery.fn = jQuery.prototype = {
	...
	***REMOVED***,
	...
	eq: function( i ) {
		var len = this.length,
			j = +i + ( i < 0 ? len : 0 );
		return this.pushStack( j ***REMOVED***= 0 && j < len ? [ this[j] ] : [] );
	***REMOVED***,
...
jQuery.extend({
	...
	***REMOVED***,
	...
	isNumeric: function( obj ) {
		...
		// ***REMOVED***but misinterprets leading-number strings, particularly hex literals ("0x***REMOVED***")
		// subtraction forces infinities to NaN
		// adding 1 corrects loss of precision from parseFloat (#15100)
		return !jQuery.isArray( obj ) && (obj - parseFloat( obj ) + 1) ***REMOVED***= 0;
	***REMOVED***,
...
function isArraylike( obj ) {
	...
	***REMOVED***
	...
	return type === "array" || length === 0 ||
		typeof length === "number" && length ***REMOVED*** 0 && ( length - 1 ) in obj;
***REMOVED***
var Sizzle =
/*!
...
var i,
	...
	***REMOVED***,
	...
	matchExpr = {
		...
		"needsContext": new RegExp( "^" + whitespace + "*[***REMOVED***+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" +
	...
	funescape = function( _, escaped, escapedWhitespace ) {
		...
		return high !== high || escapedWhitespace ?
			...
			high < 0 ?
				...
				String.fromCharCode( high ***REMOVED******REMOVED*** 10 | 0xD800, high & 0x3FF | 0xDC00 );
	***REMOVED***,
...
function createCache() {
	...
	function cache( key, value ) {
		...
		if ( keys.push( key + " " ) ***REMOVED*** Expr.cacheLength ) {
	...
	***REMOVED***;
	...
	if ( (support.qsa = rnative.test( doc.querySelectorAll )) ) {
		...
		assert(function( div ) {
			...
			docElem.appendChild( div ).innerHTML = "<a id='" + expando + "'***REMOVED***</a***REMOVED***" +
				"<select id='" + expando + "-\f]' msallowcapture=''***REMOVED***" +
				"<option selected=''***REMOVED***</option***REMOVED***</select***REMOVED***";
...
Sizzle.matchesSelector = function( elem, expr ) {
	...
	***REMOVED***
	...
	return Sizzle( expr, document, null, [ elem ] ).length ***REMOVED*** 0;
***REMOVED***;
		...
		***REMOVED***,
		...
		"CHILD": function( match ) {
			/* matches from matchExpr["CHILD"]
				...
				3 argument (even|odd|\d*|\d*n([+-]\d+)?|***REMOVED***)
			...
			return function( elem ) {
				...
				***REMOVED***
				...
				return operator === "=" ? result === check :
					...
					operator === "~=" ? ( " " + result.replace( rwhitespace, " " ) + " " ).indexOf( check ) ***REMOVED*** -1 :
				...
				function( elem, context, xml ) {
					...
					if ( parent ) {
						...
						***REMOVED*** else if ( useCache && (cache = (elem[ expando ] || (elem[ expando ] = {***REMOVED***))[ type ]) && cache[0] === dirruns ) {
						...
						// xml :nth-child(***REMOVED***) or :nth-last-child(***REMOVED***) or :nth(-last)?-of-type(***REMOVED***)
						***REMOVED*** else {
						...
						***REMOVED***
						...
						diff -= last;
						return diff === first || ( diff % first === 0 && diff / first ***REMOVED***= 0 );
					***REMOVED***
				***REMOVED***;
		***REMOVED***,
	...
	pseudos: {
		...
		***REMOVED***),
		...
		"has": markFunction(function( selector ) {
			return function( elem ) {
				return Sizzle( selector, elem ).length ***REMOVED*** 0;
			***REMOVED***;
		***REMOVED***),
		...
		"contains": markFunction(function( text ) {
			...
			return function( elem ) {
				return ( elem.textContent || elem.innerText || getText( elem ) ).indexOf( text ) ***REMOVED*** -1;
			***REMOVED***;
		***REMOVED***),
...
function elementMatcher( matchers ) {
	return matchers.length ***REMOVED*** 1 ?
		function( elem, context, xml ) {
		...
		var temp, i, elem,
			...
			matcherOut = matcher ?
				...
				postFinder || ( seed ? preFilter : preexisting || postFilter ) ?
					...
					// ***REMOVED***intermediate processing is necessary
					[] :

					// ***REMOVED***otherwise use results directly
					results :
				matcherIn;
	...
	for ( ; i < len; i++ ) {
		...
		***REMOVED*** else {
			...
			if ( matcher[ expando ] ) {
				...
				***REMOVED***
				return setMatcher(
					i ***REMOVED*** 1 && elementMatcher( matchers ),
					i ***REMOVED*** 1 && toSelector(
...
function matcherFromGroupMatchers( elementMatchers, setMatchers ) {
	var bySet = setMatchers.length ***REMOVED*** 0,
		byElement = elementMatchers.length ***REMOVED*** 0,
			...
			***REMOVED***
			...
			if ( bySet && i !== matchedCount ) {
				...
				***REMOVED***
				...
				if ( outermost && !seed && setMatched.length ***REMOVED*** 0 &&
					( matchedCount + setMatchers.length ) ***REMOVED*** 1 ) {
...
select = Sizzle.select = function( selector, context, results, seed ) {
	...
	if ( match.length === 1 ) {
		...
		if ( tokens.length ***REMOVED*** 2 && (token = tokens[0]).type === "ID" &&
...
if ( !assert(function( div ) {
	div.innerHTML = "<a href='#'***REMOVED***</a***REMOVED***";
...
var rsingleTag = (/^<(\w+)\s*\/?***REMOVED***(?:<\/\1***REMOVED***|)$/);
...
function winnow( elements, qualifier, not ) {
	...
	***REMOVED***
	...
	return jQuery.grep( elements, function( elem ) {
		return ( indexOf.call( qualifier, elem ) ***REMOVED***= 0 ) !== not;
	***REMOVED***);
***REMOVED***
...
jQuery.fn.extend({
	find: function( selector ) {
		...
		***REMOVED***
		...
		ret = this.pushStack( len ***REMOVED*** 1 ? jQuery.unique( ret ) : ret );
	...
	***REMOVED***,
	...
	closest: function( selectors, context ) {
		...
		***REMOVED***
		...
		return this.pushStack( matched.length ***REMOVED*** 1 ? jQuery.unique( matched ) : matched );
	***REMOVED***,
		...
		***REMOVED***,
		...
		self = {
			...
			remove: function() {
				if ( list ) {
					jQuery.each( arguments, function( _, arg ) {
						var index;
						while ( ( index = jQuery.inArray( arg, list, index ) ) ***REMOVED*** -1 ) {
							list.splice( index, 1 );
			...
			***REMOVED***,
			...
			has: function( fn ) {
				return fn ? jQuery.inArray( fn, list ) ***REMOVED*** -1 : !!( list && list.length );
			***REMOVED***,
...
jQuery.extend({
	...
	***REMOVED***,
	...
	// Deferred helper
	when: function( subordinate /* , ***REMOVED***, subordinateN */ ) {
		var i = 0,
			...
			updateFunc = function( i, contexts, values ) {
				return function( value ) {
					contexts[ i ] = this;
					values[ i ] = arguments.length ***REMOVED*** 1 ? slice.call( arguments ) : value;
	...
	***REMOVED***,
	...
	ready: function( wait ) {
		...
		***REMOVED***
		...
		if ( wait !== true && --jQuery.readyWait ***REMOVED*** 0 ) {
			return;
		***REMOVED***
	...
	***REMOVED*** else if ( value !== undefined ) {
		...
		***REMOVED***
		...
		if ( bulk ) {
			...
			// ***REMOVED***except when executing function values
			***REMOVED*** else {
				bulk = fn;
	...
	remove: function( owner, key ) {
		...
		***REMOVED*** else {
			...
			if ( jQuery.isArray( key ) ) {
				// If "name" is an array of keys***REMOVED***
		...
		return access( this, function( value ) {
			...
			***REMOVED***
			...
			this.each(function() {
				...
				// This might not apply to all properties***REMOVED****
				data_user.set( this, camelKey, value );

				// ****REMOVED*** In the case of properties that might _actually_
				...
				***REMOVED***
			***REMOVED***);
		***REMOVED***, null, value, arguments.length ***REMOVED*** 1, null, true );
	***REMOVED***,
...
(function() {
	...
	div.innerHTML = "<textarea***REMOVED***x</textarea***REMOVED***";
...
jQuery.event = {
	...
	***REMOVED***,
	...
	handlers: function( event, handlers ) {
		...
		// Black-hole SVG <use***REMOVED*** instance trees (#13180)
					...
					for ( i = 0; i < delegateCount; i++ ) {
						...
						if ( matches[ sel ] === undefined ) {
							matches[ sel ] = handleObj.needsContext ?
								jQuery( sel, this ).index( cur ) ***REMOVED***= 0 :
...
function defaultDisplay( nodeName ) {
	...
	if ( !display ) {
		...
		if ( display === "none" || !display ) {
			...
			iframe = (iframe || jQuery( "<iframe frameborder='0' width='0' height='0'/***REMOVED***" )).appendTo( doc.documentElement );
	...
	***REMOVED***
	...
	if ( computed ) {
		...
		***REMOVED***
		...
		// this is against the CSSOM draft ***REMOVED*** http://dev.w3.org/csswg/cssom/#resolved-values
...
jQuery.fn.extend({
	css: function( name, value ) {
		...
		***REMOVED***, name, value, arguments.length ***REMOVED*** 1 );
	***REMOVED***,
	show: function() {
...
jQuery.speed = function( speed, easing, fn ) {
	...
	***REMOVED***;
	...
	// Normalize opt.queue - true/undefined/null -***REMOVED*** "fx"
			...
			for ( ; i < len; i++ ) {
				...
				if ( cur ) {
					...
					while ( (clazz = classes[j++]) ) {
						...
						while ( cur.indexOf( " " + clazz + " " ) ***REMOVED***= 0 ) {
	...
	***REMOVED***,
	...
	hasClass: function( selector ) {
		var className = " " + selector + " ",
			...
			l = this.length;
		for ( ; i < l; i++ ) {
			if ( this[i].nodeType === 1 && (" " + this[i].className + " ").replace(rclass, " ").indexOf( className ) ***REMOVED***= 0 ) {
				return true;
			***REMOVED***
		***REMOVED***
		...
		select: {
			...
			***REMOVED***,
			...
			set: function( elem, value ) {
				...
				while ( i-- ) {
					option = options[ i ];
					if ( (option.selected = jQuery.inArray( option.value, values ) ***REMOVED***= 0) ) {
						optionSet = true;
					***REMOVED***
				***REMOVED***
...
jQuery.each([ "radio", "checkbox" ], function() {
	jQuery.valHooks[ this ] = {
		set: function( elem, value ) {
			if ( jQuery.isArray( value ) ) {
				return ( elem.checked = jQuery.inArray( jQuery(elem).val(), value ) ***REMOVED***= 0 );
			***REMOVED***
		***REMOVED***
	***REMOVED***;
	if ( !support.checkOn ) {
	...
	***REMOVED***,
	...
	ajax: function( url, options ) {
		...
		***REMOVED*** else {
			...
			***REMOVED***
			// Timeout
			if ( s.async && s.timeout ***REMOVED*** 0 ) {
		...
		***REMOVED***
		...
		function done( status, nativeStatusText, responses, headers ) {
			...
			***REMOVED***
			...
			// Set readyState
			jqXHR.readyState = status ***REMOVED*** 0 ? 4 : 0;

			// Determine if successful
			isSuccess = status ***REMOVED***= 200 && status < 300 || status === 304;
	...
	if ( self.length ***REMOVED*** 0 ) {
		...
		***REMOVED***).done(function( responseText ) {
			...
			self.html( selector ?
				...
				jQuery("<div***REMOVED***").append( jQuery.parseHTML( responseText ) ).find( selector ) :
	...
	setOffset: function( elem, options, i ) {
		...
		***REMOVED***
		...
		calculatePosition = ( position === "absolute" || position === "fixed" ) &&
			( curCSSTop + curCSSLeft ).indexOf("auto") ***REMOVED*** -1;
