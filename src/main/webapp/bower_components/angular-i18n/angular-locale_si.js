...
***REMOVED***
  ...
  ***REMOVED***,
  "id": "si",
  "pluralCat": function(n, opt_precision) {  var i = n | 0;  var vf = getVF(n, opt_precision);  if ((n == 0 || n == 1) || i == 0 && vf.f == 1) {    return PLURAL_CATEGORY.ONE;  ***REMOVED***  return PLURAL_CATEGORY.OTHER;***REMOVED***
***REMOVED***);
***REMOVED***]);
