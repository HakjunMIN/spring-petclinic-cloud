 ...
 * Example of jsTestDriver.conf for running scenario tests with JSTD:
  <pre***REMOVED***
    ...
    proxy:
     - {matcher: "/your-prefix/*", server: "http://localhost:8000/"***REMOVED***
  </pre***REMOVED***
 *
 * For more information on how to configure jstd proxy, see {@link http://code.google.com/p/js-test-driver/wiki/Proxy***REMOVED***
 ...
 *
 * Whenever you use <code***REMOVED***browser().navigateTo('relativeUrl')</code***REMOVED*** in your scenario test, the relativeUrlPrefix will be prepended.
 ...
 * Now, when you call <code***REMOVED***browser().navigateTo('index.html')</code***REMOVED*** in your scenario test, the browser will open /your-prefix/index.html.
...
function JstdPlugin() {
   ...
   *
   * @param {jstestdriver.TestRunConfiguration***REMOVED*** configuration
   * @param {Function***REMOVED*** onTestDone
   * @param {Function***REMOVED*** onAllTestsComplete
   * @returns {boolean***REMOVED*** True if this type of test is handled by this plugin, false otherwise
   */
    ...
    testRunsConfiguration.push(
        new jstestdriver.TestRunConfiguration(
            new jstestdriver.TestCaseInfo(
                'Angular Scenario Tests', function() {***REMOVED***, SCENARIO_TYPE), []));
 ...
 *
 * @param {Object***REMOVED*** jstestdriver Undefined when run from browser (without jstd)
 * @param {Function***REMOVED*** initScenarioAndRun Function that inits scenario and runs all the tests
 * @param {Object=***REMOVED*** config Configuration object, supported properties:
 ...
 *
 * @param {angular.scenario.ObjectModel.Spec***REMOVED*** spec
 * @returns {jstestdriver.TestResult***REMOVED***
 */
