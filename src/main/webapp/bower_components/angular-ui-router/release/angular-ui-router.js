  ...
  this.study = function (invocables) {
    ...
    function visit(value, key) {
      ...
      if (visited[key] === VISIT_IN_PROGRESS) {
        ...
        throw new Error("Cyclic dependency: " + cycle.join(" -***REMOVED*** "));
***REMOVED***
...
function $TemplateFactory(  $http,   $templateCache,   $injector) {
  ...
  ***REMOVED***;
   ...
   * @return {string|Promise.<string***REMOVED******REMOVED*** The template html as a string, or a promise 
   * for that string.
   */
...
function UrlMatcher(pattern, config, parentMatcher) {
  ...
  //    \{([\w\[\]]+)(?:\:( ***REMOVED*** ))?\***REMOVED***  - curly brace placeholder ($3) with optional regexp/type ***REMOVED*** ($4) (search version has - for snake-case
  //    (?: ***REMOVED*** | ***REMOVED*** | ***REMOVED*** )+         - the regexp consists of any number of atoms, an atom being either
  ...
  var placeholder       = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:((?:[^{***REMOVED***\\]+|\\.|\{(?:[^{***REMOVED***\\]+|\\.)*\***REMOVED***)+))?\***REMOVED***/g,
      searchPlaceholder = /([:]?)([\w\[\]-]+)|\{([\w\[\]-]+)(?:\:((?:[^{***REMOVED***\\]+|\\.|\{(?:[^{***REMOVED***\\]+|\\.)*\***REMOVED***)+))?\***REMOVED***/g,
      compiled = '^', last = 0, m,
  ...
  ***REMOVED***
  ...
  function matchDetails(m, isSearch) {
    ...
    type        = $$UMFP.type(regexp || "string") || inherit($$UMFP.type("string"), { pattern: new RegExp(regexp) ***REMOVED***);
    return {
  ...
  ***REMOVED***
  ...
  while ((m = placeholder.exec(pattern))) {
    ...
    if (p.segment.indexOf('?') ***REMOVED***= 0) break; // we're into the search part
...
UrlMatcher.prototype.exec = function (path, searchParams) {
  ...
  function decodePathArray(string) {
    ...
    function unquoteDashes(str) { return str.replace(/\\-/, "-"); ***REMOVED***
 ...
 * 
 * @returns {Array.<string***REMOVED******REMOVED***  An array of parameter names. Must be treated as read-only. If the
...
function $UrlMatcherFactory() {
  ...
  function valToString(val) { return val != null ? val.toString().replace(/\//g, "%2F") : val; ***REMOVED***
  function valFromString(val) { return val != null ? val.toString().replace(/%2F/g, "/") : val; ***REMOVED***
//  TODO: in 1.0, make string .is() return false if value is undefined by default.
//  function regexpMatches(val) { /*jshint validthis:true */ return isDefined(val) && this.pattern.test(val); ***REMOVED***
  function regexpMatches(val) { /*jshint validthis:true */ return this.pattern.test(val); ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***;
   ...
   *     // in the list
   *     return list.indexOf(item) ***REMOVED*** -1;
   *   ***REMOVED***
   * ***REMOVED***);
   *
...
function $UrlRouterProvider(   $locationProvider,   $urlMatcherFactory) {
  ...
  ***REMOVED***
   ...
   * </pre***REMOVED***
   *
   * @param {object***REMOVED*** rule Handler function that takes `$injector` and `$location`
  ...
  ***REMOVED***;
   ...
   * </pre***REMOVED***
   *
   * @param {string|object***REMOVED*** rule The url path you want to redirect to or a function 
  ...
  ***REMOVED***
   ...
   * @param {string|object***REMOVED*** handler The path you want to redirect your user to.
   */
...
***REMOVED***,
      ...
      push: function(urlMatcher, params, options) {
        $location.url(urlMatcher.format(params || {***REMOVED***));
