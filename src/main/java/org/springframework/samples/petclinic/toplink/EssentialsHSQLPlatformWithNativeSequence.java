 ...
 *
 * <p***REMOVED***Necessary for PetClinic's default data model, which relies on identity
 * columns: this is uniformly used across all persistence layer implementations
 * (JDBC, Hibernate, and JPA).
 *
 * @author Juergen Hoeller
 * @author <a href="mailto:james.x.clark@oracle.com"***REMOVED***James Clark</a***REMOVED***
 * @since 1.2
 */
