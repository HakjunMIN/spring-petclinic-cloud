 ...
 *
 * Is a FactoryBean, for exposing the fully-initialized DataSource as a Spring bean. See {@link #getObject()***REMOVED***.
 *
 * @author Chris Beams
 * @author Scott Andrews
 */
public class DbcpDataSourceFactory implements FactoryBean<DataSource***REMOVED***, DisposableBean {
	...
	***REMOVED***
	...
	public Class<DataSource***REMOVED*** getObjectType() {
