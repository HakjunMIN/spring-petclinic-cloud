 ...
 *
 * <p***REMOVED***SimpleJdbcClinic is a rewrite of the AbstractJdbcClinic which was the base
...
public class SimpleJdbcClinic implements Clinic, SimpleJdbcClinicMBean {
	...
	***REMOVED***
	...
	public void refreshVetsCache() throws DataAccessException {
		synchronized (this.vets) {
			...
			final List<Specialty***REMOVED*** specialties = this.simpleJdbcTemplate.query(
					"SELECT id, name FROM specialties",
					ParameterizedBeanPropertyRowMapper.newInstance(Specialty.class));

			// Build each vet's list of specialties.
			for (Vet vet : this.vets) {
				final List<Integer***REMOVED*** vetSpecialtiesIds = this.simpleJdbcTemplate.query(
	...
	***REMOVED***
	...
	public Collection<Owner***REMOVED*** findOwners(String lastName) throws DataAccessException {
		List<Owner***REMOVED*** owners = this.simpleJdbcTemplate.query(
	...
	***REMOVED***
	...
	private void loadVisits(JdbcPet pet) {
		final List<Visit***REMOVED*** visits = this.simpleJdbcTemplate.query(
	...
	***REMOVED***
	...
	private void loadPetsAndVisits(final Owner owner) {
		final List<JdbcPet***REMOVED*** pets = this.simpleJdbcTemplate.query(
