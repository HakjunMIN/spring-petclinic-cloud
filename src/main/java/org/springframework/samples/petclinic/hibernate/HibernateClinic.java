 ...
 *
 * <p***REMOVED***The mappings are defined in "petclinic.hbm.xml", located in the root of the
 * class path.
 *
 * <p***REMOVED***Note that transactions are declared with annotations and that some methods
