...
public class OwnerResource {
  ...
  ***REMOVED***
    ***REMOVED***
    ...
    public Collection<Owner***REMOVED*** findOwners(@RequestParam("lastName") String ownerLastName) {

    	if (ownerLastName == null) {
    		ownerLastName = "";
    	***REMOVED***
    	
        Collection<Owner***REMOVED*** results = this.clinicService.findOwnerByLastName(ownerLastName);
        if (results.isEmpty()) {
            return null;
  ***REMOVED***
        else {
  ...
  ***REMOVED***
    ***REMOVED***
    ...
    @RequestMapping(value = "/owner/{ownerId***REMOVED***/edit", method = RequestMethod.GET)
    ...
    ***REMOVED***
    ...
    @RequestMapping(value = "/owner/{ownerId***REMOVED***/edit", method = RequestMethod.PUT)
  ...
  ***REMOVED***
    ***REMOVED***
     ...
     */
    @RequestMapping(value = "/owner/{ownerId***REMOVED***", method = RequestMethod.GET,
            produces = MediaType.APPLICATION_JSON_VALUE)
