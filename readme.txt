...
- ant clean        --***REMOVED*** cleans the project
- ant clean test   --***REMOVED*** cleans the project and runs all tests
- ant clean jar    --***REMOVED*** cleans the project and builds the WAR
