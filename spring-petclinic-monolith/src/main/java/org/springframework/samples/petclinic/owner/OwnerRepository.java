...
/**
 * Repository class for <code***REMOVED***Owner</code***REMOVED*** domain objects All method names are compliant
...
public interface OwnerRepository extends Repository<Owner, Integer***REMOVED*** {
	...
	@Transactional(readOnly = true)
	Page<Owner***REMOVED*** findByLastName(@Param("lastName") String lastName, Pageable pageable);
	...
	@Transactional(readOnly = true)
	Page<Owner***REMOVED*** findAll(Pageable pageable);
