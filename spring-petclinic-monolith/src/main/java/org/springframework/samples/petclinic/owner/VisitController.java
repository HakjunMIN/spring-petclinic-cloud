...
class VisitController {
	...
	***REMOVED***
	...
	public Visit loadPetWithVisit(@PathVariable("ownerId") int ownerId, @PathVariable("petId") int petId,
			Map<String, Object***REMOVED*** model) {
	...
	***REMOVED***
	...
	// Spring MVC calls method loadPetWithVisit(***REMOVED***) before initNewVisitForm is
	// called
	@GetMapping("/owners/{ownerId***REMOVED***/pets/{petId***REMOVED***/visits/new")
	public String initNewVisitForm(@PathVariable("petId") int petId, Map<String, Object***REMOVED*** model) {
		return "pets/createOrUpdateVisitForm";
	***REMOVED***

	// Spring MVC calls method loadPetWithVisit(***REMOVED***) before processNewVisitForm is
	// called
