...
/**
 * Repository class for <code***REMOVED***Vet</code***REMOVED*** domain objects All method names are compliant
...
public interface VetRepository extends Repository<Vet, Integer***REMOVED*** {
	...
	/**
	 * Retrieve all <code***REMOVED***Vet</code***REMOVED***s from data store in Pages
	 * @param pageable
	 * @return
	...
	@Transactional(readOnly = true)
	@Cacheable("vets")
	Page<Vet***REMOVED*** findAll(Pageable pageable) throws DataAccessException;
