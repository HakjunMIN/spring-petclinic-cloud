...
class CacheConfiguration {
	...
	***REMOVED***
	 ...
	 */
	private javax.cache.configuration.Configuration<Object, Object***REMOVED*** cacheConfiguration() {
		return new MutableConfiguration<***REMOVED***().setStatisticsEnabled(true);
	***REMOVED***
